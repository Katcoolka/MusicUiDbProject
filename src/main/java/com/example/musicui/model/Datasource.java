...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:E:\\Java udemy\\inteliJ_IDEA_projects\\S19_Databases\\MusicUI\\" + DB_NAME;

    //constants for ALBUMS table
    ...
    //constants for ARTISTS table
    public static final String TABLE_ARTISTS = "artists";
    public static final String COLUMN_ARTIST_ID = "_id";
    public static final String COLUMN_ARTIST_NAME = "name";

    //indices for ARTISTS table
    public static final int INDEX_ARTIST_ID = 1;
    public static final int INDEX_ARTIST_NAME = 2;

    //constants for SONGS table
    ...
    //constants for prepared statements
    ...
    //constants for statements - to check if an artist or an album already exists in the table
    ...
    //constants for java fx exercise
    ...
    //the variable that will hold that one instance of the class (singleton).
    private static Datasource instance = new Datasource();

    // private constructor - only the class will be able to create instances of itself
    private Datasource(){

    }
    //So when an object wants to use the singleton instance, it calls get instance, the public static method we've just created. The method checks to see if the singleton instance has been previously created.
    ...
    // the query artists method retrieves all the records from the artists’ table.
    ...
    // a method to get the albums for an artist
    ...
    //general query on songs table returning metadata
    ...
    // count function query with assigned name using (AS)
    ...
    //method for creating the view of the song artist
    ...
    //method for inserting artist if it does not exist
    ...
    //method for inserting album if it does not exist
    ...
    // method to update an artist name
    ...
    //method for inserting song if it does not exist
